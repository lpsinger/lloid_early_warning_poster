...
\begin{tikzpicture}[
	...
	\matrix (m) [
		...
		& & & & & & \node[resample, color=diagramaccum] (resample01) {\tiny$\uparrow$}; & \node[resample, color=diagramaccum] (resample11) {\tiny$\uparrow$}; & \node[resample, color=diagramaccum] (resample21) {\tiny$\uparrow$}; & \node{$\cdot \cdot$}; & \node[resample, color=diagramaccum] (resample31) {\tiny$\uparrow$}; \\
%
		...
		& & & & & & \node[resample, color=diagramaccum] (resample02) {\tiny$\uparrow$}; & \node[resample, color=diagramaccum] (resample12) {\tiny$\uparrow$}; & \node[resample, color=diagramaccum] (resample22) {\tiny$\uparrow$}; & \node{$\cdot \cdot$}; & \node[resample, color=diagramaccum] (resample32) {\tiny$\uparrow$}; \\
%
