...
\PARstart{W}e have demonstrated a computationally feasible filtering algorithm for the rapid and
...
\PARstart{A}ccuracy and latency are critical parameters to measure. We employ a
\gstreamer{}-based implementation of the \lloid{} algorithm. Below are the
masses used for the test and the resulting time-slice design.
...
This poster was prepared by NF and LS based on a preprint article designated
LIGO-P0900004 and authored by Kipp Cannon, Romain Cariou, Mireia
Crispin-Ortuzar, NF, Melissa Frei, Chad Hann, Erin Kara, Drew Keppel, Laura
Liao, Stephen Privitera, LS, and Alan Weinstein. \LIGO\ was constructed by the
California Institute of Technology and Massachusetts Institute of Technology
with funding from the National Science Foundation and operates under
cooperative agreement \textsc{phy}-\oldstylenums{0107417}. This research is
