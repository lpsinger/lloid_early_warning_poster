...
\bf\PARstart{A}{s}\rm\ a compact binary system loses energy to gravitational waves (\GW{}s), its
...
\bf\PARstart{W}{e}\rm\ have demonstrated a computationally feasible filtering algorithm
...
\bf\PARstart{A}{ccuracy}\rm\ and latency are critical parameters. Figures
