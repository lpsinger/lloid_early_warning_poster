...
\begin{table}
\caption{\label{table:flops}Computational cost in \flops\ of the \TD\ method, the \FD\ method, and \lloid\ for the sub-bank described in Figure~\ref{fig:tmpltbank}. \textsc{mbta} was the S6/VSR3 low-latency trigger generator~\cite{HugheyGWPAW2011}.}
\begin{center}
\begin{tabular}{lll}
\toprule
