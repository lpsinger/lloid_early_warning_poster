...
early_warning_slides.pdf: early_warning_slides.tex figures/snr_in_time.png figures/snr_psd.png figures/fd_latency.png figures/lloid-diagram.pdf figures/envelope.png figures/original-templates.pdf figures/svd-templates.pdf
