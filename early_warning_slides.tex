...
\title[LIGO-G1100864-v1]{Toward early-warning detection \\ of compact binary coalescence}
%\subtitle[?]{?}
...
\begin{frame}
	...
	\begin{flushleft}
	\footnotesize{Image from Racusin et al., ``Broadband observations of the naked-eye $\gamma$-ray burst GRB 080319B,'' Nature 455 183--188 (2008), \url{http://www.nature.com/nature/journal/v455/n7210/pdf/nature07270.pdf}.}
	\end{flushleft}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.4\textwidth}
			...
			\begin{equation*}
				\approx \left(1 + \frac{\textrm{filter length}}{\textrm{latency}}\right)
			\end{equation*}
			operations~/~sample~/ $2 \lg (\textrm{template length})$.
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\end{enumerate}
	\begin{flushright}
		\raisebox{-2cm}{~\smash{\includegraphics[width=0.6\textwidth]{figures/tmpltbank}}}
	\end{flushright}
\end{frame}
