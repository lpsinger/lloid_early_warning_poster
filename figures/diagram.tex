...
\begin{tikzpicture}[
	...
	\matrix (m) [
		...
		& & & \node[draw, color=\diagramcolorfir] (u00) {}; & \node[junction, color=\diagramcolorreconstruct] (u00tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v00) {}; & \node[adder, draw=\diagramcoloraccum] (add00) {}; & & & & & \node[signal, label=right:{$\rho_0^0$}] (out00) {}; \\
		& & & \node[draw, color=\diagramcolorfir] (u10) {}; & \node[junction, color=\diagramcolorreconstruct] (u10tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v10) {}; & & \node[adder, draw=\diagramcoloraccum] (add10) {}; & & & & \node[signal, label=right:{$\rho_1^0$}] (out10) {}; \\
		\node[signal, label=left:{$x$}] (x) {}; & \node[junction] (in0) {}; & \node[junction, color=\diagramcolorfir] (in0tee) {}; & & & \node[adder, draw=\diagramcolorreconstruct] (v20) {}; & & & \node[adder, draw=\diagramcoloraccum] (add20) {}; & & & \node[signal, label=right:{$\rho_2^0$}] (out20) {}; \\
		& & & & & \node[vdots]{$\colon$}; & & & & & & \node[vdots]{$\colon$}; \\
		& & & \node[draw, color=\diagramcolorfir] (u20) {}; & \node[junction, color=\diagramcolorreconstruct] (u20tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v30) {}; & & & & & \node[adder, draw=\diagramcoloraccum] (add30) {}; & \node[signal, label=right:{$\rho_{M-1}^0$}] (out30) {}; \\
		& & & & & & & & \node[minimum height=6mm](delay0){}; & & & \\
		& & & & & & \node[resample, color=\diagramcoloraccum] (resample01) {\tiny$\uparrow$}; & \node[resample, color=\diagramcoloraccum] (resample11) {\tiny$\uparrow$}; & \node[resample, color=\diagramcoloraccum] (resample21) {\tiny$\uparrow$}; & \node{$\cdot \cdot$}; & \node[resample, color=\diagramcoloraccum] (resample31) {\tiny$\uparrow$}; \\
%
		& & & \node[draw, color=\diagramcolorfir] (u01) {}; & \node[junction, color=\diagramcolorreconstruct] (u01tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v01) {}; & \node[adder, draw=\diagramcoloraccum] (add01) {}; & & & & & \node[signal, label=right:{$\rho_0^1$}] (out01) {}; \\
		& & & \node[draw, color=\diagramcolorfir] (u11) {}; & \node[junction, color=\diagramcolorreconstruct] (u11tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v11) {}; & & \node[adder, draw=\diagramcoloraccum] (add11) {}; & & & & \node[signal, label=right:{$\rho_1^1$}] (out11) {}; \\
		& \node[resample] (in1) {\tiny$\downarrow$}; & \node[junction, color=\diagramcolorfir] (in1tee) {}; & & & \node[adder, draw=\diagramcolorreconstruct] (v21) {}; & & & \node[adder, draw=\diagramcoloraccum] (add21) {}; & & & \node[signal, label=right:{$\rho_2^1$}] (out21) {}; \\
		& & & & & \node[vdots]{$\colon$}; & & & & & & \node[vdots]{$\colon$}; \\
		& & & \node[draw, color=\diagramcolorfir] (u21) {}; & \node[junction, color=\diagramcolorreconstruct] (u21tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v31) {}; & & & & & \node[adder, draw=\diagramcoloraccum] (add31) {}; & \node[signal, label=right:{$\rho_{M-1}^1$}] (out31) {}; \\
		& & & & & & & & \node[minimum height=6mm](delay1){}; & & & \\
		& & & & & & \node[resample, color=\diagramcoloraccum] (resample02) {\tiny$\uparrow$}; & \node[resample, color=\diagramcoloraccum] (resample12) {\tiny$\uparrow$}; & \node[resample, color=\diagramcoloraccum] (resample22) {\tiny$\uparrow$}; & \node{$\cdot \cdot$}; & \node[resample, color=\diagramcoloraccum] (resample32) {\tiny$\uparrow$}; \\
%
...
%
		& & & \node[draw, color=\diagramcolorfir] (u02) {}; & \node[junction, color=\diagramcolorreconstruct] (u02tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v02) {}; & \node[junction, color=\diagramcoloraccum] (add02) {}; & & & & & \node[signal, label=right:{$\rho_0^{S-1}$}] (out02) {}; \\
		& & & \node[draw, color=\diagramcolorfir] (u12) {}; & \node[junction, color=\diagramcolorreconstruct] (u12tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v12) {}; & & \node[junction, color=\diagramcoloraccum] (add12) {}; & & & & \node[signal, label=right:{$\rho_1^{S-1}$}] (out12) {}; \\
		& \node[junction] (in2) {}; & \node[junction, color=\diagramcolorfir] (in2tee) {}; & & & \node[adder, draw=\diagramcolorreconstruct] (v22) {}; & & & \node[junction, color=\diagramcoloraccum] (add22) {}; & & & \node[signal, label=right:{$\rho_2^{S-1}$}] (out22) {}; \\
		& & & & & \node[vdots]{$\colon$}; & & & & & & \node[vdots]{$\colon$}; \\
		& & & \node[draw, color=\diagramcolorfir] (u22) {}; & \node[junction, color=\diagramcolorreconstruct] (u22tee) {}; & \node[adder, draw=\diagramcolorreconstruct] (v32) {}; & & & & & \node[junction, color=\diagramcoloraccum] (add32) {}; & \node[signal, label=right:{$\rho_{M-1}^{S-1}$}] (out32) {}; \\
	};

	\foreach \i in {0,1,2} {
		\draw[loosely dotted] ($0.3*(add2\i) + 0.7*(add3\i)$) -- ($0.7*(add2\i) + 0.3*(add3\i)$);
		\node[draw,dashed,line width=0.5pt,fit=(in\i tee) (u0\i) (u2\i), color=\diagramcolorfir] {};
		\node[draw,dashed,line width=0.5pt,yshift=0.5mm,fit=(u0\i tee) (v3\i), color=\diagramcolorreconstruct] {};
		\foreach \j in {0,1,2,3}
			\foreach \k in {0,1,2} {
				\draw[color=\diagramcolorreconstruct] (u\k \i tee) -- (v\j \i);
				\draw[->] (v\j \i) -- (add\j \i);
			}
		\foreach \k in {0,1,2} {
			\draw[color=\diagramcolorfir] (in\i tee) |- (u\k \i);
	...
	\node[draw,color=\diagramcoloraccum,fill=white,minimum width=22mm,xshift=1mm,label=right:{\small delay}] at (delay0) {\tiny$z^{-t^1 f^0}$};
	\node[draw,color=\diagramcoloraccum,fill=white,minimum width=22mm,xshift=1mm,label=right:{\small delay}] at (delay1) {\tiny$z^{-(t^2-t^1) f^1}$};
	\draw[->] (in0) -- (in1);
	\draw (in1) -- (invdots);
	\draw[->] (invdots) -- (in2);
	\draw[->] (x) -- (in0);
	...
	\draw[decorate, color=\diagramcolorfir, decoration={brace, amplitude=4pt}] ($(intee)+(-2mm,0)$) -- ($(u)+(2mm,0)$) node[midway,above=2mm,align=center] {Orthogonal \\ \textsc{fir} filters};
	\draw[decorate, color=\diagramcolorreconstruct, decoration={brace, amplitude=4pt}] ($(utee)+(-2mm,0)$) -- ($(v)+(2mm,0)$) node[midway,above=2mm,align=center] {Reconstruction \\ matrices};
	\draw[decorate, color=\diagramcoloraccum, decoration={brace, amplitude=4pt}] ($(add0)+(-2mm,0)$) -- ($(add3)+(2mm,0)$) node[midway,above=2mm,align=center] {Interpolation and \\ \textsc{snr} accumulation};
\end{tikzpicture}
